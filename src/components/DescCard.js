...
const DescCard=({ammo,ammoPic,capacity,des})=>{
    ...
    return <View style={{padding:'4%',width:'90%',backgroundColor:'orange',alignSelf:'center', borderRadius:10, marginTop:'5%',shadowOffset:{
        width:0,
        height:10,
         },
shadowOpacity:0.25,
shadowRadius:3.5,
elevation:5}}>
        <View style={{padding:'5%',width:'100%',backgroundColor:'white',alignSelf:'center',marginTop:'3%',borderRadius:10}}>
