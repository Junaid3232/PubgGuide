...
const Tabs=()=> {
  return (
    ...
    <Tab.Navigator initialRouteName="Home" tabBarOptions={{
      ...
      <Tab.Screen name="Game" component={GunsScreen} options={{ tabBarIcon:({focused})=>(
          <View style={{alignItems:'center', justifyContent:'center', top:10}}>
              ...
              <Text style={{color:focused?'#e32f45':'#748c94', fontSize:12}}> Tips</Text>
          </View>
      )}} />
      ...
      <Tab.Screen name="Accout" component={GunsScreen}
